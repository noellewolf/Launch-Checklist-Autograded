...
// console log an input's status, then return false if not valid and true if valid
 ...
 function formSubmission(pilotName, copilotName, fuelLevel, cargoMass) {
    ...
    if(validateInput(pilotName) == true) validInputs = true
    if(validateInput(copilotName) == true) validInputs = true
    if(validateInput(fuelLevel) == true) validInputs = true
    if(validateInput(cargoMass) == true) validInputs = true
    else if(validInputs == true) console.log("INVALID INPUTS")
